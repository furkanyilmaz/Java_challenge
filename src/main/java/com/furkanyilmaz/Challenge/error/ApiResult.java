package com.furkanyilmaz.Challenge.error;
...
//validationError: null ise dönmesini istemeyebiliriz.

//Eğer null dönerse ekranda null olanı gösterme.
@JsonInclude(JsonInclude.Include.NON_NULL)//ignore to empty fields in an object
